...
3. **Clone Repository**: `git clone https://github.com/TanUjNimkar/aws-eks-gitops-ecommerce-platform.git`
...
```sh
git clone https://github.com/TanUjNimkar/aws-eks-gitops-ecommerce-platform.git
cd aws-eks-gitops-ecommerce-platform
```
